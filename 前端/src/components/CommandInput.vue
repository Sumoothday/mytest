  ...
  <div class="game-box command-panel">
    ...
    <div class="block">
      <div class="move-buttons">
        <button @click="send('go north')">⬆</button>
        <div class="middle">
          <button @click="send('go west')">⬅</button>
          <button @click="send('look')">🔍</button>
          <button @click="send('go east')">➡</button>
        </div>
        <button @click="send('go south')">⬇</button>
      </div>
    </div>
    ...
    <div class="block">
      <div class="action-buttons">
        <button @click="send('items')">🎒 背包</button>
        <button @click="send('back')">🔙 返回</button>
        <button @click="send('take')">📥 拾取</button>
        <button @click="send('drop')">📤 丢弃</button>
        <button @click="send('eat cookie')">🍪 魔法饼干</button>
      </div>
    </div>

    <!-- 自定义输入 -->
    <div class="block input-block">
      <input type="text" v-model="command" placeholder="请输入指令…" @keyup.enter="submit" />
